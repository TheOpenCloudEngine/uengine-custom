...
<head>
    ...
    <!-- grid -->
    <link rel="stylesheet" href="scripts/jquery.jqGrid_JS_5.1.1/css/ui.jqgrid.css" />

    <script type="text/javascript" src="scripts/jquery.jqGrid-4.3.1/js/i18n/grid.locale-en.js"></script>
    <script type="text/javascript" src="scripts/jquery.jqGrid_JS_5.1.1/js/jquery.jqGrid.min.js"></script>
...
//			 			}, 100);*/
        ...
        OG.handler.EventHandler.prototype.enableEditLabel  = function(element){
        };

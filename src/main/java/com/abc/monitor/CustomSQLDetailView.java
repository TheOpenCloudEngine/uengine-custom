...
/**
 * Created by uEngineYBS on 2016-07-29.
 */
public class CustomSQLDetailView {


    public CustomSQLDetailView() {
    }

    public CustomSQLDetailView(Console console, String instanceId, String tracingTag) {
